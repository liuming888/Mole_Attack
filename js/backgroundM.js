    ...
    BackgroundM.prototype.render = function() {
        ...
        case 0: //进来画面
            ...
            game.canvas.onclick = function(e) {
                if (e.offsetX >= 352 && e.offsetY <= 426 && e.offsetY >= 182 && e.offsetY <= 253) {
                    //点击中锤子头部分
        ...
        case 2: //游戏画面（主战场的逻辑）
            ...
            break;
        case 3: //游戏结束画面
            this.mainBackground.pause();
            game.land.render(); //渲染背景地
            game.ctx.drawImage(game.R['gameover'], 200, 300);
            game.ctx.drawImage(game.R['restart'], 320, 420);
            game.canvas.onclick = function(e) {
                if (e.offsetX > 322 && e.offsetX < 409 && e.offsetY > 420 && e.offsetY < 515) {
                    //点击重新开始按钮时
                    self.page = 2; //回到游戏页面
